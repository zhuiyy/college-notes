...
### 按弦的泛音列
在一条弦1/2处按弦, 并拨动琴弦, 则正相反, 按弦强制1/2处产生波节, 因此只会产生另一半泛音列(奇次泛音):
$$2f, 4f, 6f, ...$$
...
$${3_{12}\over 2_{18}} = 1.0136 \times 2> 1 \times 2$$
### 多声部音乐
复调音乐(对位法), 主调音乐
## 纯律--扎利诺等
...
2) 法国长笛乐派由演奏家**米歇尔-布拉维**开创.
3) Aratos三重奏演奏的西藏舞曲\<Tibet dancing\>由**盛宗亮**作曲.